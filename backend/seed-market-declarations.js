...
const MarketDeclaration = require('./src/models/MarketDeclaration');
...
const connectDB = async () => {
  try {
    ...
    await seedMarketDeclarations();
    
    console.log('✅ Market Declarations seeding completed successfully!');
    process.exit(0);
  } catch (error) {
