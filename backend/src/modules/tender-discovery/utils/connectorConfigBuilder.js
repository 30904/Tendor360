...
function buildConnectorConfigFromSource(source = {}, company = null) {
  ...
  return {
    ...
    loginUsername: scraping.loginUsername || auth.username,
    loginPassword: scraping.loginPassword || auth.password,
    ...
    followDetailLinks: scraping.followDetailLinks !== false,
    detailTitleSelector: scraping.detailTitleSelector || '',
    detailBodySelector: scraping.detailBodySelector || '',
    detailPageTimeoutMs: Number(scraping.detailPageTimeoutMs) || 30000,
    detailDelayMs: Number(scraping.detailDelayMs) || 0,
    skipDetailKeywordRecheck: scraping.skipDetailKeywordRecheck === true,
