...
const WORKSPACE_FIELDS = [
  { name: 'reference', label: 'CO reference', placeholder: 'CO-2024-001', required: true },
  { name: 'contract', label: 'Contract / project', placeholder: 'Highway expansion phase 2', required: true },
  { name: 'title', label: 'Change title', placeholder: 'Scope adjustment', required: true },
  { name: 'estimatedValue', label: 'Estimated value (USD)', type: 'number', min: 0, placeholder: '250000' },
  { name: 'description', label: 'Description', type: 'textarea', placeholder: 'Summarize the commercial and schedule impact' }
]
...
const ChangeOrders = () => {
  ...
  const handleCreateChangeOrder = (formData) => {
    showToast.success(`Change order draft ${formData.reference} created`)
  ...
  return (
    <>
      ...
      <PostAwardWorkspaceModal
        ...
        description="Capture a new variation for commercial review and approval routing."
